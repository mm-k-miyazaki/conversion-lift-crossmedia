...
OUTPUT_ROOT <- "/Volumes/sales-lift/ryo_takahashi/netflix様_セールスリフト/時点考慮FQテスト"
...
PIPELINE_CONFIG <- list(
  ...
  projects = list(
    ...
    # --------------------------------------------------------------------------
    list(
      project_id = "Piccoma_ori",
      project_name = "Piccoma様_オリジナル",
      output_filename_prefix = "Piccoma様_オリジナル",
      data_type = "ACUBE",
      ...
      category_specs = list(
        make_zero_plus_decile_category_segment_spec(
          value_col = "新プレ_利用時間",
          category_col = "新プレ_利用時間_category",
          segment_col = "新プレ_利用時間_segment",
          axis_label = "新プレ_利用時間_segment",
          category_prefix = "新プレ利用時間"
        )
      ),
    ...
    list(
      project_id = "Piccoma_fq1",
      project_name = "Piccoma様_fq1",
      output_filename_prefix = "Piccoma様_fq1",
      data_type = "ACUBE",
      
      input_mode = "MASTERDATA",
      masterdata_path = "/Volumes/sales-lift/ryo_takahashi/netflix様_セールスリフト/時点考慮/ピッコマ/ピッコマ_timeconsiderd_fq_pattern1.csv",
    ...
    list(
      project_id = "Piccoma_fq2",
      project_name = "Piccoma様_fq2",
      output_filename_prefix = "Piccoma様_fq2",
      data_type = "ACUBE",
      
      input_mode = "MASTERDATA",
      masterdata_path = "/Volumes/sales-lift/ryo_takahashi/netflix様_セールスリフト/時点考慮/ピッコマ/ピッコマ_timeconsiderd_fq_pattern2.csv",
